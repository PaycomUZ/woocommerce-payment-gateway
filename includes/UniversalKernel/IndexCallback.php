	...
	static function Construct($db_group){
		...
		if(isset($_SERVER['PHP_AUTH_USER']))
		{
			...
			$Sql['PerformTransaction'][] = array(
					'Sql' => 'UPDATE {TABLE_PREFIX}posts SET post_status = :p_state WHERE ID = :p_cms_order_id',
					'Param'=>array(
							':p_state' => 'wc-completed'
					)
			);
